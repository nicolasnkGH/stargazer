import { ExternalLink, Star, ArrowUpRight, Tag } from "lucide-react";
    ...
    <footer className="w-full border-t border-white/10 bg-slate-950/50 mt-8">
      <div className="mx-auto max-w-5xl px-4 sm:px-8 py-10">
        ...
        <div className="flex flex-wrap items-center gap-2.5 mb-8 pb-8 border-b border-white/5">
          ...
          >
            <Star className="h-3 w-3" strokeWidth={1.5} /> {stars != null ? stars.toLocaleString() : "—"} Stars
          </a>
          {latestTag && (
            <a
            ...
            >
              <Tag className="h-3 w-3" strokeWidth={1.5} /> {latestTag}
            </a>
          )}
          <a
          ...
          >
            Collaborate <ArrowUpRight className="h-3 w-3" strokeWidth={1.5} />
          </a>
        </div>
