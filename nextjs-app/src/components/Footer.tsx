import { FiExternalLink, FiStar, FiArrowUpRight, FiTag } from "react-icons/fi";
    ...
    <footer className="w-full border-t border-white/10 bg-slate-950/50 mt-8">
      <div className="mx-auto max-w-[1600px] px-4 sm:px-8 py-10">
        ...
        <div className="flex flex-wrap items-center gap-2.5 mb-8 pb-8 border-b border-white/5">
          ...
          >
            <FiStar className="h-3 w-3" /> {stars != null ? stars.toLocaleString() : "—"} Stars
          </a>
          {latestTag && (
            <a
            ...
            >
              <FiTag className="h-3 w-3" /> {latestTag}
            </a>
          )}
          <a
          ...
          >
            Collaborate <FiArrowUpRight className="h-3 w-3" />
          </a>
        </div>
