    ...
    >
      <div className="card-header justify-between flex-wrap gap-2 px-6 py-4 border-b border-sky-500/20 bg-slate-900/80">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h2 className="text-base font-bold text-slate-100 tracking-wide">{t("interactive_3d_solar_system")}</h2>
        ...
        <div className="flex items-center gap-3">
          <SourceTooltip
            ...
            description={t("source_nasa_desc")}
            attribution={t("source_nasa_attr")}
          />
          <button
          ...
          >
            <span>{isFullscreen ? t("btn_close_fullscreen") : t("btn_expand")}</span>
          </button>
          <a
            href={nasaUrl}
            target="_blank"
          ...
          >
            <span>{t("link_open_nasa_eyes")}</span>
          </a>
        </div>
      </div>
      ...
      >
        {!interactive ? (
          ...
          >
            ...
            <h3 className="text-base font-bold text-white mb-1">{t("nasa_3d_title")}</h3>
